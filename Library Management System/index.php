    ...
    <main>
        <form id="login_form" class="form_class" method="POST">
            <div class="form_div">
                ...
                <button class="submit_class" type="submit" form="login_form" name="login">Login</button>
                <small style="color:white; font-weight: 400;">Visit First Time <a href="signup.php" style="text-decoration: none; color: cyan;">Signup Here</a></small>
                <?php
